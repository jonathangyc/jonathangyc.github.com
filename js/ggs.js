/*
*
*	Golden Gridlet in Pink
*	redeveloped by Jonathan Chen	<http://www.jonathanc.com/>
*
*	Original Golden Gridlet		 	<http://goldengridsystem.com/>
...
var guideColor = 'rgb(255,0,0)';
var guideInnerColor = 'rgba(255,255,255, 0.91)';
var guideOpacity = '0.2';

var switchColor = 'rgb(0,0,0)';
var switchOpacity = '0.618';

var baseFontSize = 16;
var baselineGridHeight = (6 / baseFontSize)+'em';

var eightCol 				= ((480) / baseFontSize)+'em';
var eightColBreakpoint 		= ((480-1) / baseFontSize)+'em';
var twelveCol 				= ((640) / baseFontSize)+'em';
var twelveColBreakpoint 	= ((640-1) / baseFontSize)+'em';
var twentyfourCol 			= ((1552) / baseFontSize)+'em';
...
/* Calculate the amount of lines needed and append them */
		var lines = Math.floor(largerHeight/6);
...
/* Set the baseline container to the same height as the guides, so there's no overflow */
		ender('#ggs-baseline-container').css('height', largerHeight+1);
	}
}
...
/*  Create CSS */
    var styles = '\
        ...
        .ggs-0{left:0%;}\
        .ggs-1{left:6%; display:none;}\
        .ggs-2{left:10%; display:none;}\
        .ggs-3{left:14%; display:none;}\
        .ggs-4{left:18%; display:none;}\
        .ggs-5{left:22%; display:none;}\
        .ggs-6{left:26%; display:none;}\
        .ggs-7{left:30%; display:none;}\
        .ggs-8{left:34%; display:none;}\
        .ggs-9{left:38%; display:none;}\
        .ggs-10{left:42%; display:none;}\
        .ggs-11{left:46%; display:none;}\
        .ggs-12{left:50%; display:none;}\
        .ggs-13{left:54%; display:none;}\
        .ggs-14{left:58%; display:none;}\
        .ggs-15{left:62%; display:none;}\
		.ggs-16{left:66%; display:none;}\
		.ggs-17{left:70%; display:none;}\
		.ggs-18{left:74%; display:none;}\
		.ggs-19{left:78%; display:none;}\
		.ggs-20{left:82%; display:none;}\
		.ggs-21{left:86%; display:none;}\
		.ggs-22{left:90%; display:none;}\
		.ggs-23{left:94%; display:none;}\
        .ggs-24{right:0;}\
        .ggs-0,.ggs-24{width:2%;padding-right:0.75em;border:0;margin:0;}\
        ...
        #ggs-baseline-container {opacity: '+guideOpacity+'; position: absolute; left:0; top:-1px; z-index: 8000; width: 100%; height: 100%; -webkit-transition: opacity 0.235s ease-out; -moz-transition: opacity 0.235s ease-out; -ms-transition: opacity 0.235s ease-out; transition: opacity 0.235s ease-out; overflow-y: hidden;}\
        ...
        @media screen and (min-width: '+(eightCol)+') and (max-width: '+(twelveColBreakpoint)+'){.ggs-3,.ggs-6,.ggs-9,.ggs-12,.ggs-15,.ggs-18,.ggs-21{display:block;}}\
		@media screen and (max-width: '+(eightColBreakpoint)+'){.ggs-6,.ggs-12,.ggs-18{display:block;}}\
		@media screen and (min-width: '+(twelveCol)+'){.ggs-2,.ggs-4,.ggs-6,.ggs-8,.ggs-10,.ggs-12,.ggs-14,.ggs-16,.ggs-18,.ggs-20,.ggs-22{display:block;}}\
		@media screen and (min-width: '+(twentyfourCol)+'){.ggs-1,.ggs-3,.ggs-5,.ggs-7,.ggs-9,.ggs-11,.ggs-13,.ggs-15,.ggs-17,.ggs-19,.ggs-21,.ggs-23{display:block;}}\
    ';	
